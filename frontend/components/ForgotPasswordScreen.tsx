...
const ForgotPasswordScreen: React.FC<ForgotPasswordScreenProps> = ({ onNavigateToLogin, onNavigateToSignup, onNavigateToHome }) => {
              ...
              <div className="text-center">
                ...
                <div className="bg-teal-50 border border-teal-200 rounded-xl p-4 mb-8">
                  <p className="text-sm text-teal-800 leading-relaxed">
                    <strong>Next step:</strong> Click the link in your email to reset your password. The link expires in 24 hours.
                  </p>
                </div>
