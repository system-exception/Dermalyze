 ...
 */
const ResultCard: React.FC<ResultCardProps> = ({ classId, className, confidence, info, imageUrl, gradcamImage }) => {
            ...
            <div className="aspect-square w-full bg-slate-50 rounded-lg overflow-hidden border border-slate-100 flex items-center justify-center relative">
              {displayImage ? (
                <>
                  <img
                    src={displayImage}
                    alt={showHeatmap && gradcamImage ? "Grad-CAM heatmap showing important regions" : "Analyzed lesion"}
